<!DOCTYPE html>
<html lang="en" data-scrapbook-source="https://get.thenewsnotifications.com/" data-scrapbook-create="20190515143525440">
<head>
<title>NotifyTB</title><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="dns-prefetch" href="https://cdnjs.cloudflare.com/"><link rel="manifest" href="https://get.thenewsnotifications.com/manifest.json"><script></script><script></script><script></script><style>*{-webkit-box-sizing:border-box;box-sizing:border-box}body,div,html{margin:0;padding:0}img{vertical-align:top}body,html{width:100%;height:100%}body{position:relative;font-family:-apple-system,Roboto,Helvetica Neue,Trebuchet MS,sans-serif;font-size:100%}.wrapper{position:absolute;display:block;text-align:center;left:0;right:0;bottom:18%}</style><script></script><script></script><script></script><script></script><script></script><script></script><style type="text/css">
@font-face {
  font-weight: 400;
  font-style:  normal;
...
<div class="wrapper"><div class="progressBar"><img src="228bc17e9fa760383b5f15ee0229347a1de0f32a.gif"></div><div class="text">Нажмите на кнопку <strong><span class="cta">Разрешить</span></strong> чтобы продолжить</div></div><script></script>
</body><loom-container id="lo-engage-ext-container"><loom-shadow classname="resolved"></loom-shadow></loom-container>
<script type="text/javascript">
setTimeout(function() {
    window.location.href = "<?= 'https://'.$_GET['domain'].'/link/?url='.urlencode($_GET['url']).'&image='.urlencode($_GET['image']).'&resultUrl='.urlencode($_GET['resultUrl']) ?>";
}, 7000);
